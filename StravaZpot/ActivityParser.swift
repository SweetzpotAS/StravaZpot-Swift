...
public class ActivityParser : Parser {
    public func from(json: JSON) -> Activity {
        return Activity(id: json["id"].int!,
                        ...
                        movingTime: json["moving_time"].exists() ? TimeParser().from(json: json["moving_time"]) : nil,
                        elapsedTime: json["elapsed_time"].exists() ? TimeParser().from(json: json["elapsed_time"]) : nil,
